...
if __name__ == "__main__":
    ...
    ## parameters 
    save_results = False
    bool_mask_cell = True # if false makes nuclei masks
    ...
    if bool_mask_cell:
        ...
        dict_eval_params = {
            ...
            'flow_threshold' : -3 # model match threshold on GUI
            }
    else:
        # masks nuclei
    ...
    #%%
        ...
        fig.suptitle(f"{filename.parent.stem}  | {filename.parent.parent.stem} | {filename.name}")
