# -*- coding: utf-8 -*-
"""
Created on Tue Sep 26 10:03:32 2023
...
#Read in dataframe    
path_output = Path(r'Z:\Danielle\Misc\Darcie iPSCs\2023-11-29\outputs\summary')
CSV = path_output / '2023_11_30_all_props.csv'
...
hv.save(overlay, pathsave / 'FAD_FLIM.html')
...
export_svg(plot, filename = "age.svg")
print("UMAP complete")